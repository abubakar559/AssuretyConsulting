...
class Instagram(unittest.TestCase):
    ...
    def test_login(self):
        ...
        #Job Import Validations
        driver.find_element_by_xpath('//*[@id="ctl00_imgConfig"]').click() 
        time.sleep(3) #settings
        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_LeftMenuSettings_AccordionPane3_header"]').click()
        time.sleep(2)  #MailAssurety
        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_LeftMenuSettings_AccordionPane3_content_lbJobImport"]').click()
        time.sleep(2) #Job Import
        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_masterContentPlaceHolder_Label31"]').click()
        time.sleep(2) #Postal One Validation 
        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_masterContentPlaceHolder_chPerformPostalOneValidationAtImport"]').click()
        time.sleep(2) #Check box selection 
        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_masterContentPlaceHolder_Label31"]').click()
        time.sleep(2) #Postal One Validation    

        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_masterContentPlaceHolder_Label47"]').click()
        time.sleep(2) #Import Validations 
        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_masterContentPlaceHolder_cbValidateRequiredFields"]').click()
        time.sleep(1)
        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_masterContentPlaceHolder_cbValidateRequiredFieldsDataTypes"]').click()
        time.sleep(1)
        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_masterContentPlaceHolder_cbValidateRefrentialIntegrity"]').click()
        time.sleep(1)
        driver.find_element_by_xpath('//*[@id="ctl00_ctl00_masterContentPlaceHolder_masterContentPlaceHolder_imgbtSave"]').click()
        time.sleep(3)#savebtn

        # driver.find_element_by_xpath('//*[@id="ctl00_ctl00_hljobs"]/label').click()
        # time.sleep(5)
    ...
    # if the status isn't 'Passed', refresh the page and wait for a bit before checking again
        ...
        # #change because check box tick in default 
